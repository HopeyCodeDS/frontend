...
const AppointmentCard = ({appointment, onViewDetails, onDelete, appointmentNumber}: {
    ...
    getArrivalWindow(appointment.scheduledTime);
            ...
            <CardHeader
                ...
                action={
                    <Chip
                        ...
                        color={getStatusColor(appointment.status) as never}
                        size="small"
                ...
                <Box>
                    ...
                    <Box sx={{display: 'flex', alignItems: 'center', gap: 1, mt: 1}}>
                        <Typography variant="caption" color="info.main">
                            Data
                            source: {Array.isArray(appointments) && appointments.length > 0 ? 'Backend' : 'Mock Data'}
                        </Typography>
                    </Box>
                </Box>
