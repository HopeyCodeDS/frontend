...
export const VALIDATION = {
    ...
    MAX_TRUCK_WEIGHT: 25, // 50 tons maximum
...
export const USER_ROLES = {
    ...
    INSPECTOR: 'INSPECTOR',
    BUNKERING_OFFICER: 'BUNKERING_OFFICER',
    FOREMAN: 'FOREMAN',
...
export const PAGE_ACCESS_ROLES = {
    TRUCKS: [USER_ROLES.TRUCK_DRIVER, USER_ROLES.WAREHOUSE_MANAGER, USER_ROLES.FOREMAN],
    WAREHOUSES: [USER_ROLES.WAREHOUSE_MANAGER, USER_ROLES.SELLER],
    PURCHASE_ORDERS: [USER_ROLES.BUYER, USER_ROLES.ACCOUNTANT, USER_ROLES.WAREHOUSE_MANAGER],
    SHIPPING_ORDERS: [USER_ROLES.SHIP_CAPTAIN, USER_ROLES.FOREMAN, USER_ROLES.INSPECTOR, USER_ROLES.BUNKERING_OFFICER, USER_ROLES.WAREHOUSE_MANAGER],
    APPOINTMENTS: [USER_ROLES.SELLER, USER_ROLES.BUYER, USER_ROLES.WAREHOUSE_MANAGER]
} as const;